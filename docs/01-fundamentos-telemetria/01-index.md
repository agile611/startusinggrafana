...
**Fundamentos de telemetría y monitorización basada en métricas**

### Duración recomendada

- **Sesión única:** 3 horas.
- **Formato dividido:** 2 sesiones de 90 minutos.
- **Trabajo práctico adicional:** 60 minutos.

### Objetivos de aprendizaje

Al finalizar este bloque, el alumnado podrá:
...
- Interpretar una serie temporal mediante su nombre, valor, instante y etiquetas.
- Comprender cómo afectan el intervalo de muestreo y la retención al sistema de monitorización.
...
El alumnado debería disponer de:

- Un equipo con Ubuntu 24.04.5 LTS o una máquina virtual.
...
- Terminal.
- Navegador.
- Grafana instalado, si se realiza la parte de integración.
- Prometheus y Node Exporter, si se realiza el laboratorio completo.

---

## 2. Contenido que puedes poner en `01-index.md`

Sustituye el contenido provisional por este:
